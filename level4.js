...
//            this.load.image('trees', 'assets/trees.png');
            this.load.image('clouds', 'assets_volcano/volcano.png');
            this.load.image('platform', 'assets_volcano/platform-black.png');
            this.load.image('ice-platform', 'assets_volcano/lavaplatform.png');
            this.load.spritesheet('dude', 'assets_volcano/dude.png', 32, 48);
